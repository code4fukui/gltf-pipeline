...
//const Promise from "bluebird");
import "./bluebird.js";
import { addDefaults } from "./addDefaults.js";
...
import { removePipelineExtras } from "./removePipelineExtras.js";
import { removeUnusedElements } from "./removeUnusedElements.js";
import { updateVersion } from "./updateVersion.js";
import { writeResources } from "./writeResources.js";
//import { compressDracoMeshes } from "./compressDracoMeshes.js";
 ...
 */
export function processGltf(gltf, options) {
...
function getStages(options) {
  ...
  if (defined(options.dracoOptions)) {
    ...
    throw new Error("DRACO not supported")
  }
