...
import mime from "https://code4fukui.github.io/mime/index.js";
import { addBuffer } from "./addBuffer.js";
import { ForEach } from "./ForEach.js";
import { getImageExtension } from "./getImageExtension.js";
 ...
 * @private
 */
export function writeResources(gltf, options) {
...
function writeDataUri(object, extension) {
  ...
  object.uri = `data:${mimeType};base64,${Base64.encode(source)}`;
}
